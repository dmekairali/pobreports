  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Real-time visit quality tracking and performance</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Quality Metrics</CardTitle>
          <CardDescription>Visit quality analysis and suspicious activity detection</CardDescription>
        </CardHeader>
        <CardContent>
