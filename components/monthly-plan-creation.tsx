...
import { AIMonthlyPlanner } from "@/components/ai-monthly-planner"
            ...
            <Card className="border-green-200">
              ...
              <CardContent className="space-y-2">
                <div className="space-y-2">
                  ...
                  <div className="p-2 bg-purple-50 rounded text-xs border-l-2 border-purple-500">
                    <div className="flex items-center justify-between mb-1">
                    ...
                    <p className="font-semibold">Health Plus Clinic</p>
                    <p className="text-gray-600">Dr. Singh • 40 min</p>
                    <div className="flex items-center mt-1">
                      <MapPin className="h-3 w-3 mr-1 text-gray-500" />
              ...
              <CardContent className="space-y-2">
                <div className="space-y-2">
                  <div className="p-2 bg-red-50 rounded text-xs border-l-2 border-red-500">
                    ...
                    <div className="flex items-center mt-1">
                      <MapPin className="h-3 w-3 mr-1 text-gray-500" />
                      <span className="text-gray-500">4.1 km</span>
                    </div>
                  </div>
                  ...
                  <div className="p-2 bg-green-50 rounded text-xs border-l-2 border-green-500">
                    ...
                    <p className="font-semibold">Prime Medical</p>
                    <p className="text-gray-600">Dr. Gupta • 45 min</p>
                    <div className="flex items-center mt-1">
                      <MapPin className="h-3 w-3 mr-1 text-gray-500" />
                      <span className="text-gray-500">2.7 km</span>
                    </div>
                  </div>

                  <div className="p-2 bg-yellow-50 rounded text-xs border-l-2 border-yellow-500">
                    <div className="flex items-center justify-between mb-1">
                      <span className="font-medium">11:15 AM</span>
                      <Badge className="bg-yellow-100 text-yellow-800 text-xs">New</Badge>
                    </div>
                    <p className="font-semibold">Wellness Center</p>
                    <p className="text-gray-600">Dr. Jain • 60 min</p>
                    <div className="flex items-center mt-1">
                      <MapPin className="h-3 w-3 mr-1 text-gray-500" />
                      <span className="text-gray-500">1.5 km</span>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-2">
                <div className="space-y-2">
                  <div className="p-2 bg-green-50 rounded text-xs border-l-2 border-green-500">
                    ...
                    <p className="font-semibold">Apollo Clinic</p>
                    <p className="text-gray-600">Dr. Reddy • 40 min</p>
                    <div className="flex items-center mt-1">
                      <MapPin className="h-3 w-3 mr-1 text-gray-500" />
                      <span className="text-gray-500">3.8 km</span>
                    </div>
                  </div>
                  ...
                  <div className="p-2 bg-blue-50 rounded text-xs border-l-2 border-blue-500">
                    ...
                    <p className="font-semibold">Care Pharmacy</p>
                    <p className="text-gray-600">Mr. Shah • 25 min</p>
                    <div className="flex items-center mt-1">
                      <MapPin className="h-3 w-3 mr-1 text-gray-500" />
              ...
              <CardContent className="space-y-2">
                <div className="space-y-2">
                  <div className="p-2 bg-red-50 rounded text-xs border-l-2 border-red-500">
                    ...
                    <p className="text-gray-600">Dr. Agarwal • 55 min</p>
                    <div className="flex items-center mt-1">
                      <MapPin className="h-3 w-3 mr-1 text-gray-500" />
              ...
              <CardContent className="space-y-2">
                <div className="space-y-2">
                  <div className="p-2 bg-green-50 rounded text-xs border-l-2 border-green-500">
                    ...
                    <p className="font-semibold">Fortis Hospital</p>
                    <p className="text-gray-600">Dr. Kapoor • 50 min</p>
                    <div className="flex items-center mt-1">
                      <MapPin className="h-3 w-3 mr-1 text-gray-500" />
                      <span className="text-gray-500">4.5 km</span>
                    </div>
                  </div>
            ...
            <Card className="border-gray-200 bg-gray-50">
              ...
              <CardContent>
                <div className="text-center py-4">
                  ...
                  <p className="text-xs text-gray-400">Plan preparation time</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-gray-200 bg-gray-50">
              ...
              <CardContent>
                <div className="text-center py-4">
                  ...
                  <p className="text-xs text-gray-400">Next week planning</p>
                </div>
              </CardContent>
            </Card>
          </div>

          {/* Daily Details Modal Trigger */}
          <Card>
            <CardHeader>
